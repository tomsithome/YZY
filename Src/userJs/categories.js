layui.config({
    ...
    var mainList = function (options) {
        ...
        table.reload('mainList', {
            url: '/Categories/All?randow=' + Math.random(),
            where: config
        });
        ...
        var show = function (data) {
            ...
            layer.open({
                ...
                success: function() {
                    ...
                    $("#configdisc").val(data.Description);
                },
                end: mainList
            });
...
//头部导航栏
//$.tj.loadTab("/Categories/Index");
$.tj.loadTabAutority("a94d5648-c2a9-405e-ba6f-f1602ec9b807");
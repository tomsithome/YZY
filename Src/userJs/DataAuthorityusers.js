    ...
    var active = {
        ...
        , btnAssignDataAuthority: function () {
            ...
            var index = toplayer.open({
                title: "为用户【" + data[0].Name + "】分配数据权限",
                type: 2,
                area: ['500px', '400px'],
                content: "/DataAuthority/Assign?type=UserDataAuthority&tablename=" + getQueryString("tablename") + "&dataId=" + getQueryString("dataId") + "&userId=" + data[0].Id,
